<?php
	...
	$cfg['valid']  		= array('gif', 'jpg', 'jpeg', 'png','pdf','doc','swf','fla');						// valid extentions for image files	
...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		array (																		
			'value'   	=> '/standardcms_tmce/UserFiles/',												
			'text'    	=> 'Images',
		),
		array (
			'value'   	=> '/standardcms_tmce/UserFiles/', 				
	...
	$cfg['main_dir'] 	= dirname("C:/wamp/www/standardcms_tmce/admin/tiny_mce/plugins/ibrowser");//dirname($_SERVER['PHP_SELF']); 								// iBrowser main dir; e.g. '/home/domain/public_html/ibrowser/'	
	$cfg['main_dir']    = ereg_replace("//", "/", dirname("C:/wamp/www/standardcms_tmce/admin/tiny_mce/plugins/ibrowser"));
