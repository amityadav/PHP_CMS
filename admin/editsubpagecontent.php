											...
											<option value="">Select Parent Page</option>
											 <?php
													...
													if(is_array($parentPageArray) && count($parentPageArray) > 0)
													{
														...
														{
															if($parentId == $parentPage["contentid"])
																$isSelected = "selected";
															else
																$isSelected = "";
														
															echo '<option value="' . $parentPage["contentid"] . '" ' . $isSelected . '>' . $parentPage["contentname"] . '</option>';
														}
													}
											 ?>
										</select>
										...
										<td>
										  <input type="submit" name="submit" value="<?=_SAVE_CONTENT_BUTTON_TEXT?>" class="commonbutton">	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<?
												...
												{
											?>
													<input type="submit" name="back" value="<?=_BACK_CONTENT_BUTTON_TEXT?>" class="commonbutton" onClick="return check_confirm();">
													<!--onClick="window.location='adminarea.php'">-->
											<?
												}else{
											?>
